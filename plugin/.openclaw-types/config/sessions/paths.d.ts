...
export declare function resolveRotatedGeneratedSessionFilePath(params: {
...
export declare function resolveAgentsDirFromSessionStorePath(storePath: string): string | undefined;
